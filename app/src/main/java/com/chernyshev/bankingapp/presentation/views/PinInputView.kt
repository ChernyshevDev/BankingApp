...
import com.chernyshev.bankingapp.databinding.ViewPinInputBinding
...
class PinInputView @JvmOverloads constructor(
    ...
    private val binding by lazy { ViewPinInputBinding.bind(this) }
    ...
    fun onPinEntered(onEntered: (String) -> Unit): Unit = with(binding) {
